...
export function LookBPreviewBanner1() {
  return (
...
export function LookBHeroB3() {
  return (
    <section className="hero-b">
      <img src="images/life/delivery-door.jpg" alt="Doorstep flower delivery" />
      <div className="veil"></div>
      <div className="wrap copy">
        <p className="eyebrow" style={{ color: "#fff"}}>North Bangalore · Same morning</p>
        <h1>Fresh Flowers, Every Morning.</h1>
        <p>Farm overnight. Door by breakfast. Per stem — the apartment way to order flowers.</p>
        <div className="hero-actions" style={{ display: "flex", gap: "12px", alignItems: "center", marginTop: "22px"}}>
          <a className="btn btn-primary" href="#flowers" style={{ background: "#FFFBF2", color: "#1F2E23"}}>Shop stems</a>
          <a className="wa-icon" href="https://wa.me/918147613636" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M17.5 14.4c-.3-.1-1.7-.9-2-1-.3-.1-.5-.1-.7.1-.2.3-.8 1-.9 1.1-.2.2-.3.2-.6.1-.3-.2-1.3-.5-2.4-1.5-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.6.1-.1.3-.3.4-.5.1-.1.2-.3.3-.5.1-.2 0-.4 0-.5-.1-.1-.7-1.6-.9-2.2-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.4s1 2.8 1.2 3c.1.2 2 3.1 4.9 4.3.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.5-.1 1.7-.7 1.9-1.4.2-.7.2-1.3.2-1.4-.1-.2-.3-.3-.6-.4z"></path>
              <path d="M12 2C6.5 2 2 6.5 2 12c0 1.9.5 3.6 1.4 5.1L2 22l5.1-1.3C8.5 21.6 10.2 22 12 22c5.5 0 10-4.5 10-10S17.5 2 12 2zm0 18.2c-1.6 0-3.1-.4-4.5-1.2l-.3-.2-3.4.9.9-3.3-.2-.3C3.7 14.7 3.2 13.4 3.2 12 3.2 7.2 7.2 3.2 12 3.2S20.8 7.2 20.8 12 16.8 20.2 12 20.2z"></path>
...
export function LookBMarqueeReviews4() {
  return (
    <div className="marquee reviews" data-marquee="">
      <div className="marquee-track" data-marquee-track="">
        <span className="mq-item">“Puja pack hit 7:20 at Nikoo. Unreal.” — Asha, Thanisandra</span>
        <span className="mq-item">“Finally not a bulk bunch I have to split.” — Rohan, Sobha City</span>
        <span className="mq-item">“WhatsApp at 8:40pm, roses on the table at 8:10am.” — Meera, Kannuru</span>
        <span className="mq-item">Design preview quotes · not verified reviews</span>
      </div>
    </div>
  );
}

export function LookBFlowers5() {
  return (
    <section id="flowers" className="section">
      <div className="wrap">
        <p className="eyebrow">The menu</p>
        <h2>Today’s fresh stems.</h2>
        <p>Hover for the story. Five across, scaled for the photo.</p>
...
export function LookBMarqueeFilm6() {
  return (
    <div className="marquee film" data-marquee="">
      <div className="marquee-track" data-marquee-track="">
        <span className="mq-item">
          <img src="images/life/hero-vase.jpg" alt="" />
        </span>
        <span className="mq-item">
          <img src="images/life/whatsapp-order.jpg" alt="" />
        </span>
        <span className="mq-item">
          <img src="images/life/farm-cut.jpg" alt="" />
        </span>
        <span className="mq-item">
...
export function LookBPuja7() {
  return (
    <section id="puja" className="section">
      <div className="wrap">
        <div className="puja-top">
          <img src="images/life/kraft-box.jpg" alt="Packed for morning" loading="lazy" />
          <div>
            <p className="eyebrow">Subscribe</p>
            <h2>A puja pack that just shows up.</h2>
...
export function LookBCoverage9() {
  return (
    <section id="coverage">
...
export function LookBSection10() {
  return (
    <section>
      <div className="wrap">
...
export function LookBCartBar14() {
  return (
...
export function LookBCartPanel17() {
  return (
...
export function LookBScript18() {
  return (
    <script src="js/vendor/capacitor.js"></script>
  );
}

export function LookBScript19() {
  return (
    <script src="js/fp-native.js"></script>
  );
}

export function LookBScript20() {
  return (
    <script src="js/flower-lore.js"></script>
  );
}

export function LookBScript21() {
  return (
    <script src="js/fp-looks.js?v=20260908b"></script>
  );
}

export default function LookBPage() {
  return (
    <>
      <LookBPreviewBanner1 />
      <LookBHeader2 />
      <LookBHeroB3 />
      <LookBMarqueeReviews4 />
      <LookBFlowers5 />
      <LookBMarqueeFilm6 />
      <LookBPuja7 />
      <LookBHow8 />
