...
export function GarlandsDevBanner1() {
  return (
...
export function GarlandsHeader2() {
  return (
    <header>
      <nav className="wrap">
        ...
        <div className="navlinks" id="navLinks">
          ...
          <a href="garlands.html" aria-current="page">Garlands</a>
...
export function GarlandsWrapPageHero3() {
  return (
    <section className="wrap page-hero">
      <p className="eyebrow">FreshPhool</p>
      <h1>Garlands for the altar.</h1>
      <p>Photographed from the latest client drop. Lengths as marked on each card.</p>
...
export function GarlandsGarlands4() {
  return (
    <section id="garlands">
      <div className="wrap">
...
export function GarlandsFooter5() {
  return (
    <footer>
...
export function GarlandsCartBar8() {
  return (
...
export function GarlandsCartPanel11() {
  return (
...
export default function GarlandsPage() {
  return (
    <>
      <GarlandsDevBanner1 />
      <GarlandsHeader2 />
      <GarlandsWrapPageHero3 />
      <GarlandsGarlands4 />
      <GarlandsFooter5 />
      <GarlandsNavDrawerOverlay6 />
      <GarlandsNavDrawer7 />
      <GarlandsCartBar8 />
