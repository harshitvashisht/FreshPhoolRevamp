(() => {
  ...
  // scripts/capacitor-entry.js
  init_dist();

  // node_modules/@capacitor/splash-screen/dist/esm/index.js
  init_dist();
  var SplashScreen = registerPlugin("SplashScreen", {
    web: () => Promise.resolve().then(() => (init_web(), web_exports)).then((m) => new m.SplashScreenWeb())
  });
  ...
  window.CapacitorSplashScreen = SplashScreen;
  window.CapacitorStatusBar = StatusBar;
  window.CapacitorStatusBarStyle = Style;
})();
